...
def classify_hospitals(hospitals, query_text):
    ...
    if "skin" in query_text or "rash" in query_text or "itch" in query_text:
        keywords = ["skin", "derma", "dermatology"]
    elif "eye" in query_text or "vision" in query_text:
        keywords = ["eye", "vision", "ophthal"]
    elif "heart" in query_text or "chest" in query_text:
        keywords = ["heart", "cardio"]
    else:
        return hospitals  # return all hospitals
